...
namespace LagoVista.MQTT.Core
{
    ...
    public class MqttClient
    {
        ...
        /// <param name="userCertificateValidationCallback">A RemoteCertificateValidationCallback delegate responsible for validating the certificate supplied by the remote party</param>
        /// <param name="userCertificateSelectionCallback">A LocalCertificateSelectionCallback delegate responsible for selecting the certificate used for authentication</param>
        public MqttClient(string brokerHostName, int brokerPort, bool secure, X509Certificate caCert, RemoteCertificateValidationCallback userCertificateValidationCallback, LocalCertificateSelectionCallback userCertificateSelectionCallback)
        {
...
#if !(MF_FRAMEWORK_VERSION_V4_2 || MF_FRAMEWORK_VERSION_V4_3 || COMPACT_FRAMEWORK || WINDOWS_APP || WINDOWS_PHONE_APP)
            this._channel = new MqttNetworkChannel(this._brokerHostName, this._brokerPort, secure, caCert, userCertificateValidationCallback, userCertificateSelectionCallback);
#elif (WINDOWS_APP || WINDOWS_PHONE_APP)
        ...
        private void EnqueueInternal(MqttMsgBase msg)
        {
            ...
            else if (msg.Type == MqttMsgBase.MQTT_MSG_PUBCOMP_TYPE)
            {
                lock (this._inflightQueue)
                {
                    ...
                    var msgCtx = (MqttMsgContext)this._inflightQueue.Get(msgCtxFinder.Find);
        ...
        private void ReceiveThread()
        {
            ...
            while (this._isRunning)
            {
                    ...
                    if (readBytes > 0)
                    {
                        ...
                        switch (msgType)
                        {
                            ...
                            case MqttMsgBase.MQTT_MSG_PUBACK_TYPE:
                                ...
                                var puback = MqttMsgPuback.Parse(fixedHeaderFirstByte[0], (byte)this.ProtocolVersion, this._channel);
                            ...
                            case MqttMsgBase.MQTT_MSG_PUBREC_TYPE:
                                ...
                                var pubrec = MqttMsgPubrec.Parse(fixedHeaderFirstByte[0], (byte)this.ProtocolVersion, this._channel);
                            ...
                            case MqttMsgBase.MQTT_MSG_PUBREL_TYPE:
                                ...
                                var pubrel = MqttMsgPubrel.Parse(fixedHeaderFirstByte[0], (byte)this.ProtocolVersion, this._channel);
                            ...
                            case MqttMsgBase.MQTT_MSG_UNSUBACK_TYPE:
                                ...
                                var unsuback = MqttMsgUnsuback.Parse(fixedHeaderFirstByte[0], (byte)this.ProtocolVersion, this._channel);
                ...
                {
                    //   LagoVista.Common.PlatformSupport.Services.Logger.LogException("MQTT.ReceiveThread", e);
