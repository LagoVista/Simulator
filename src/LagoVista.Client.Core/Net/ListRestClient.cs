...
{
    public class ListRestClient<TModel, TSummaryModel> : FormRestClient<TModel>, IFormRestClient<TModel, TSummaryModel> where TModel : new() where TSummaryModel : class
    {
        IRestClient _rawRestClient;

        public ListRestClient(IRestClient rawRestClient) : base(rawRestClient)
        {
