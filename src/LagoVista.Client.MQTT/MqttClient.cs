...
namespace uPLibrary.Networking.M2Mqtt
{
    ...
    public class MqttClient
    {
        ...
        private MqttMsgPingResp Ping()
        {
            ...
            {
                LagoVista.Common.PlatformSupport.Services.Logger.LogException("MQTT.Ping", e);
        ...
        private void Send(byte[] msgBytes)
        {
            ...
            {
                LagoVista.Common.PlatformSupport.Services.Logger.LogException("MQTT.Send", e);
...
#endif
                LagoVista.Common.PlatformSupport.Services.Logger.LogException("MQTT.SendReceive", e);
        ...
        private void ProcessInflightThread()
        {
            ...
            catch (MqttCommunicationException e)
            {
                ...
                LagoVista.Common.PlatformSupport.Services.Logger.LogException("MQTT.ProcessInflightThread", e);
